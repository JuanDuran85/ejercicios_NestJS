...
export class PermissionGuard implements CanActivate {
  ...
  public canActivate(
    ...
    const contextPermissions: CoffeesPermission[] =
      this.reflector.getAllAndOverride<PermissionType[]>(PERMISSIONS_KEY, [
        context.getHandler(),
        context.getClass(),
      ]);
    ...
    return contextPermissions.every((permission: CoffeesPermission) =>
